...
//second box part in interface (Noise)
	...
	private void createSShell() {
		sShell = new Shell();
		sShell.setBackground(Display.getDefault().getSystemColor(SWT.COLOR_DARK_CYAN));
		sShell.setText("IrisRecognitionSystem Implemented on JAVA");
...
//					  }
	...
	private void threadsCompleted(){
		...
		gc.fillOval(0,0, 4*iris_r, 4*iris_r);
    ...
    private void makeFiltering() {
        ...
        float[] scales = {4, 16}; //parametr scales
