...
public class AWTBufferedImageSWTImage {
  ...
  static ImageData createSWTimage(int pixels[],int width,int height){
	  DirectColorModel colormodel = new DirectColorModel(24, 0xff0000, 0xff00, 0xff);
		...
		WritableRaster raster = WritableRaster.createWritableRaster(sample, data, new java.awt.Point(0,0));
